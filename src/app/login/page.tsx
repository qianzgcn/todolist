      ...
      <div className="relative z-10 w-full max-w-sm bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl backdrop-saturate-150 rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-11 pl-10 pr-4 rounded-2xl bg-slate-200/50 dark:bg-slate-800/50 text-slate-900 dark:text-slate-100 text-sm placeholder:text-slate-400 border-none outline-none focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-blue-500/40 transition-all duration-200"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-11 pl-10 pr-10 rounded-2xl bg-slate-200/50 dark:bg-slate-800/50 text-slate-900 dark:text-slate-100 text-sm placeholder:text-slate-400 border-none outline-none focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-blue-500/40 transition-all duration-200"
                required
              />
              <button
                type="button"
          ...
          <Button
            ...
            className="w-full h-11 bg-blue-600 hover:bg-blue-500 active:scale-[0.98] text-white font-medium text-sm rounded-2xl shadow-lg shadow-blue-500/25 transition-all duration-200 cursor-pointer mt-2"
          >
            {isSubmitting ? "登录中..." : "登录"}
          </Button>
